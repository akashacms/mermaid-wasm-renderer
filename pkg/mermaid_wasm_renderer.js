/* @ts-self-types="./mermaid_wasm_renderer.d.ts" */
...
function renderSvg(source) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderSvg(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @param {string | null} [theme_preset]
 * @returns {string}
 */
function renderSvgWithConfig(source, config_json, theme_preset) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        var ptr2 = isLikeNone(theme_preset) ? 0 : passStringToWasm0(theme_preset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.renderSvgWithConfig(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
exports.renderSvgWithConfig = renderSvgWithConfig;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./mermaid_wasm_renderer_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/mermaid_wasm_renderer_bg.wasm`;
